...
NOME_ATRIBUTO_PRECIP_BRUTA = 'PrecipBruta'
...
TABELA_RETIRADA_IRRIGACAO_POR_CULTIVO_POR_MUNICIPIO =  "Historico_Retirada_Agua_Irrigacao_Por_Cultivo_Por_Municipio"
...
TABELA_AREA_CULTIVADA_MUNICIPIO_SUMARIZADA_POR_ANO = 'Historico_Area_Cultivada_Irrigacao_Sumarizada_Por_Bacia_Incremental_Por_Municipio_Por_Classe_Cultivo_Por_Ano'
...
NOME_ATRIBUTO_RETIRADA_IRRIG = 'RetiradaIrrig'
NOME_ATRIBUTO_RETIRADA_IRRIG_SUMARIZADA = 'SUM_RetiradaIrrig'
NOME_ATRIBUTO_COEF_CULTIVO = 'Kc'
NOME_ATRIBUTO_EVAPORACAO_REF = 'EtO'
NOME_ATRIBUTO_CAP_AGUA_DISP = 'CAD'
