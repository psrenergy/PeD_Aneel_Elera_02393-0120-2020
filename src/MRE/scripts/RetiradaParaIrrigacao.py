                        ...
                        for iMunicipio in range(len(ListaCodigoMunicipio)):
                            ...
                            with arcpy.da.InsertCursor(Constantes.TABELA_EVAPOTRANSPIRACAO_POTENCIAL_POR_CULTIVO, atributos) as cursorDestino:
                                ...
                                if codMunicipio in EtO:
                                    ...
                                    cursorDestino.insertRow((codMunicipio, nomeMunicipio, areaMunicipio, ano, mes, classeCultivo, areaIrrigadaCultivo, EtPC, EtO[codMunicipio], coefCultivo))
...
def CalcularFatorDisponibilidadeAguaCultivo():
    """
        ...
        f = f0 +0,04(5 -ETrc) 
            ...
            f0  : fator de referência de disponibilidade de água por cultivo (FAO 56)
            ...
            for mes in range(1,13):
                ...
                with arcpy.da.SearchCursor(Constantes.TABELA_EVAPOTRANSPIRACAO_POTENCIAL_POR_CULTIVO, atributos, sqlWhere) as cursorETPt:
                    for rowETPt in cursorETPt:
                        ...
                        atributos = [Constantes.NOME_ATRIBUTO_CODIGO_MUNICIPIO, Constantes.NOME_ATRIBUTO_NOME_MUNICIPIO, Constantes.NOME_ATRIBUTO_ANO, Constantes.NOME_ATRIBUTO_MES, Constantes.NOME_ATRIBUTO_CLASSE_CULTIVO, Constantes.NOME_ATRIBUTO_FAT_DSP_AGUA, Constantes.NOME_ATRIBUTO_FAT_DSP_AGUA_REF, Constantes.NOME_ATRIBUTO_ETPOTENCIAL]
                        with arcpy.da.InsertCursor(Constantes.TABELA_FATOR_DISPONIBILIDADE_AGUA_POR_CULTIVO, atributos) as cursorDestino:
                            cursorDestino.insertRow((codigoMunicipio, nomeMunicipio, ano, mes, classeCultivo, f, f0[classeCultivo], EtPt))
                ...
                for mes in range(1,13):
                    ...
                    for iMunicipio in range(len(ListaCodigoMunicipio)):
                        ...
                        if f:
                            ...
                            atributos = [Constantes.NOME_ATRIBUTO_CODIGO_MUNICIPIO, Constantes.NOME_ATRIBUTO_NOME_MUNICIPIO, Constantes.NOME_ATRIBUTO_ANO, Constantes.NOME_ATRIBUTO_MES, Constantes.NOME_ATRIBUTO_CLASSE_CULTIVO, Constantes.NOME_ATRIBUTO_LAMINA_DAGUA, Constantes.NOME_ATRIBUTO_CAP_TOTAL_ARM, Constantes.NOME_ATRIBUTO_FAT_DSP_AGUA]
                            with arcpy.da.InsertCursor(Constantes.TABELA_LAMINA_DAGUA_CULTIVO, atributos) as cursorDestino:
                                cursorDestino.insertRow((ListaCodigoMunicipio[iMunicipio], ListaNomeMunicipio[iMunicipio], ano, mes, ListaClasseCultivo[iMunicipio], LAA, ListaCTA[iMunicipio],  f[ListaClasseCultivo[iMunicipio]]))
...
def CalcularCapacidadeTotalArmazenamento():
    """
        ...
        CTA = CAD * Z
              CTA = Capacidade total de armazenamento (mm)                     (obs: ao multiplicar mm/cm por cm, corta-se o cm)
              CAD = Capacidade de água disponível (mm/cm)                      (Camada de disponibildiade de água da EMBRAPA)
               Z  = Profundidade efetiva do sistema radicular da cultura (cm)  (valor fixo por cultura. O dado original está expresso em metros, necessário converter para centímetros)
    """
    pymsg = ""
    msgs = ""
    ...
    try:
        ...
        with arcpy.da.SearchCursor(tabelaProfSistemaRadicularPorCultivo, atributos) as cursorZ:
            for rowZ in cursorZ:
                ...
                z[classeCultivo] = rowZ[1] * 100 #converte metros para centimetros
        ...
        for ano in range(anoInicialHistorico, anoFinalHistorico + 1):
            ...
            if camadasCultivoIrrigado: 
                ...
                ### PROCESSAMENTO BASTANTE DEMORADO NESTE PASSO!!! ###
                ...
                with arcpy.da.SearchCursor(tabelaADPorCultivoPorMunicipio, atributos) as cursorOrigem:
                    ...
                    for rowOrigem in cursorOrigem:
                        ...
                        if ADMedio:
                            ...
                            atributos = [Constantes.NOME_ATRIBUTO_CODIGO_MUNICIPIO, Constantes.NOME_ATRIBUTO_NOME_MUNICIPIO, Constantes.NOME_ATRIBUTO_ANO, Constantes.NOME_ATRIBUTO_CLASSE_CULTIVO, Constantes.NOME_ATRIBUTO_CAP_TOTAL_ARM, Constantes.NOME_ATRIBUTO_CAP_AGUA_DISP, Constantes.NOME_ATRIBUTO_PROF_RAIZ_CULTIVO]
                            with arcpy.da.InsertCursor(Constantes.TABELA_CAPACIDADE_TOTAL_ARMAZENAMENTO_POR_CULTIVO, atributos) as cursorDestino:
                                cursorDestino.insertRow((codigoMunicipio, nomeMunicipio, ano, classeCultivo, CTA, ADMedio, z[classeCultivo]))
...
def CalcularCoeficienteUmidadeSolo():
    """
        ...
        Fórmula: (ref: manual de usos consuntivos da ANA)
    ...
    # Computando os termos da equacao
                ...
                for mes in range(1,13):
                    ...
                    for iMunicipio in range(len(ListaCodigoMunicipio)):
                        ...
                        if LaminaDagua:
                            ...
                            atributos = [Constantes.NOME_ATRIBUTO_CODIGO_MUNICIPIO, Constantes.NOME_ATRIBUTO_NOME_MUNICIPIO, Constantes.NOME_ATRIBUTO_ANO, Constantes.NOME_ATRIBUTO_MES, Constantes.NOME_ATRIBUTO_CLASSE_CULTIVO, Constantes.NOME_ATRIBUTO_COEF_UMIDADE_SOLO, Constantes.NOME_ATRIBUTO_LAMINA_DAGUA, Constantes.NOME_ATRIBUTO_CAP_TOTAL_ARM]
                            with arcpy.da.InsertCursor(Constantes.TABELA_COEF_UMIDADE_SOLO, atributos) as cursorDestino:
                                cursorDestino.insertRow((ListaCodigoMunicipio[iMunicipio], ListaNomeMunicipio[iMunicipio], ano, mes, ListaClasseCultivo[iMunicipio], Ks, LAA, CTA))
...
# def CalcularPrecipitacaoEfetiva_v2():
    # """
        # Calcula a precipitação efetiva média mensal por cultivo, por municipio
        #
        # Fórmulas:
        #
            # Pe = 0.6 * P -10    Para P <= 70 mm
            # Pe = 0.8 * P -24    Para 70 <  P <= 250 mm
                ...
                #
                    ...
                    #
                        ...
                        #
                            ...
                            # precipitacaoBruta = precipitacaoMediaMunicipio[codMunicipio]
                            #
                            # if (precipitacaoBruta <= 70):
                                # precipitacaoEfetiva = (0.6 * precipitacaoBruta) -10
                                #
                            # elif ( precipitacaoBruta > 70 and precipitacaoBruta <= 250):
                                # precipitacaoEfetiva = (0.8 * precipitacaoBruta) -24
                            # else:
                                # precipitacaoEfetiva = 125 + (0.1 * precipitacaoBruta)
                                #
                            # if precipitacaoEfetiva < 0:
                                # precipitacaoEfetiva = 0
                                #
                            # # Inclusao da Precipitacao Media por Cultivo por Municipio
                            # atributos = [Constantes.NOME_ATRIBUTO_CODIGO_MUNICIPIO, Constantes.NOME_ATRIBUTO_NOME_MUNICIPIO, Constantes.NOME_ATRIBUTO_ANO, Constantes.NOME_ATRIBUTO_MES, Constantes.NOME_ATRIBUTO_CLASSE_CULTIVO, Constantes.NOME_ATRIBUTO_AREA_IRRIG_HA , Constantes.NOME_ATRIBUTO_PRECIP_BRUTA, Constantes.NOME_ATRIBUTO_PRECIP_EFETIVA]
                            # with arcpy.da.InsertCursor(Constantes.TABELA_PRECIPITACAO_EFETIVA_POR_CULTIVO, atributos) as cursorDestino:
                                # cursorDestino.insertRow((ListaCodigoMunicipio[iMunicipio], ListaNomeMunicipio[iMunicipio], ano, mes, ListaClasseCultivo[iMunicipio], ListaAreaIrrigadaCultivo[iMunicipio], precipitacaoMediaMunicipio[codMunicipio], precipitacaoEfetiva))
                                #
...
# def CalcularPrecipitacaoEfetiva_ANA():
    # """
        # Calcula a precipitação efetiva média mensal por cultivo, por municipio
        #
        # Fórmula do manual consuntivo da ANA
...
def CalcularPrecipitacaoEfetiva():
    """
        ...
        Fórmula da USDA (United States department of agriculture)
            
            Referencia: 
               M.G. Bos et al. Water Requirements for Irrigation and the Environment, 81 © Springer Science + Business Media B.V. 2009
            
            Pe = f (1.253 * P**0.824 - 2.935) * 10 ** 0.000915 * ETpc
               f    = 1
               P    = Precipitação média mensal (mm)  
               ETpc = Evapotranspiracao potencial do cultivo mensal 
    ...
    arcpy.AddMessage(time.ctime() + ' - Computando a precipitacao efetiva media por cultivo usando formulacao da USDA...')
                ...
                for mes in range(1,13):
                    ...
                    if arcpy.Exists(nomeCamadaPrecipitacaoMediaMunicipio):
                        ...
                        for iMunicipio in range(len(ListaCodigoMunicipio)):
                            ...
                            sqlWhere = Constantes.NOME_ATRIBUTO_CODIGO_MUNICIPIO + " = " + "'" + ListaCodigoMunicipio[iMunicipio]  + "' AND " + Constantes.NOME_ATRIBUTO_ANO + " = "  + str(ano) + " AND " + Constantes.NOME_ATRIBUTO_MES + " = "  + str(mes) + " AND " + Constantes.NOME_ATRIBUTO_CLASSE_CULTIVO + " = "  + str(ListaClasseCultivo[iMunicipio])
                            atributos = [Constantes.NOME_ATRIBUTO_ETPOTENCIAL]
                            with arcpy.da.SearchCursor(Constantes.TABELA_EVAPOTRANSPIRACAO_POTENCIAL_POR_CULTIVO, atributos, sqlWhere) as cursorETpc:
                                for rowETpc in cursorETpc:

                                    precipitacaoMdMunicipio = precipitacaoMediaMunicipio[codMunicipio]

                                    ETpc = rowETpc[0] # expresso em mm/dia
                                    ETpcTotMensal =  ETpc * NUMERO_DIAS_MES
                                    
                                    #if (precipitacaoMdMunicipio > 40 and ETpcTotMensal < 25):
                                    #    PrecipitacaoEfetiva = 25
                                    #elif (precipitacaoMdMunicipio > 80 and ETpcTotMensal < 50):
                                    #    PrecipitacaoEfetiva = 50
                                    #elif (precipitacaoMdMunicipio > 160 and ETpcTotMensal < 100):
                                    #    PrecipitacaoEfetiva = 100
                                    #else:    
                                    #    PrecipitacaoEfetiva = (1.253 * math.pow(precipitacaoMdMunicipio, 0.824) - 2.935) * (math.pow(10, 0.000915 * ETpcTotMensal) )
                                    ...
                                    if PrecipitacaoEfetiva > precipitacaoMdMunicipio or PrecipitacaoEfetiva > ETpcTotMensal:
                                        PrecipitacaoEfetiva = min(precipitacaoMdMunicipio, ETpcTotMensal)

                                    # Inclusao da Precipitacao Media por Cultivo por Municipio
                                    atributos = [Constantes.NOME_ATRIBUTO_CODIGO_MUNICIPIO, Constantes.NOME_ATRIBUTO_NOME_MUNICIPIO, Constantes.NOME_ATRIBUTO_ANO, Constantes.NOME_ATRIBUTO_MES, Constantes.NOME_ATRIBUTO_CLASSE_CULTIVO, Constantes.NOME_ATRIBUTO_AREA_IRRIG_HA , Constantes.NOME_ATRIBUTO_ETPOTENCIAL, Constantes.NOME_ATRIBUTO_PRECIP_BRUTA, Constantes.NOME_ATRIBUTO_PRECIP_EFETIVA]
                                    with arcpy.da.InsertCursor(Constantes.TABELA_PRECIPITACAO_EFETIVA_POR_CULTIVO, atributos) as cursorDestino:
                                        cursorDestino.insertRow((ListaCodigoMunicipio[iMunicipio], ListaNomeMunicipio[iMunicipio], ano, mes, ListaClasseCultivo[iMunicipio], ListaAreaIrrigadaCultivo[iMunicipio], ETpcTotMensal, precipitacaoMdMunicipio, PrecipitacaoEfetiva))
...
def CalcularRetiradaIrrigacao():
    ...
    arcpy.AddMessage(time.ctime() + ' - Computando a retirada de agua para irrigacao por cultivo e por municipio...')
    ...
    try:
        ...
        # Cria a tabela de retirada de agua para irrigação por cultivo, por municipio
        configurarTabelaRetiradaIrrigacaoPorCultivoPorMunicipio(Constantes.TABELA_RETIRADA_IRRIGACAO_POR_CULTIVO_POR_MUNICIPIO)
        
        atributosTabRetiradaIrrigacao = [Constantes.NOME_ATRIBUTO_CODIGO_MUNICIPIO, Constantes.NOME_ATRIBUTO_NOME_MUNICIPIO, Constantes.NOME_ATRIBUTO_AREA_MUNICIPIO_HA, Constantes.NOME_ATRIBUTO_ANO, Constantes.NOME_ATRIBUTO_MES, Constantes.NOME_ATRIBUTO_CLASSE_CULTIVO, Constantes.NOME_ATRIBUTO_AREA_CULTIVO_HA , Constantes.NOME_ATRIBUTO_PRECIP_BRUTA, Constantes.NOME_ATRIBUTO_PRECIP_EFETIVA, Constantes.NOME_ATRIBUTO_ETREAL]
        for eficAplicacao in listaEficAplicao:
            ...
            arcpy.AddField_management(Constantes.TABELA_RETIRADA_IRRIGACAO_POR_CULTIVO_POR_MUNICIPIO, nomeColunaRetiradaIrrigacao, "DOUBLE", "", "", "", "", "", "REQUIRED")
        ...
        with arcpy.da.SearchCursor(Constantes.TABELA_EVAPOTRANSPIRACAO_REAL_POR_CULTIVO, atributos) as cursorETrc:
            for rowETrc in cursorETrc:
                ...
                sqlWhere = Constantes.NOME_ATRIBUTO_CODIGO_MUNICIPIO + " = " + "'" + codigoMunicipio  + "' AND " + Constantes.NOME_ATRIBUTO_ANO + " = "  + str(ano) + " AND " + Constantes.NOME_ATRIBUTO_MES + " = "  + str(mes) + " AND " + Constantes.NOME_ATRIBUTO_CLASSE_CULTIVO + " = "  + str(classeCultivo)
                atributos = [Constantes.NOME_ATRIBUTO_PRECIP_BRUTA, Constantes.NOME_ATRIBUTO_PRECIP_EFETIVA]
                with arcpy.da.SearchCursor(Constantes.TABELA_PRECIPITACAO_EFETIVA_POR_CULTIVO, atributos, sqlWhere) as cursorPe:
                    for rowPe in cursorPe:
                        precipitacaoBruta = rowPe[0]
                        precipitacaoEfetiva = rowPe[1]
                        ...
                        ETrcTotalMensal = ETrc * NUMERO_DIAS_MES

                        #considera diferenes valores de eficiencia de irrigacao
                        listaRetiradaIrrigacao=[]
                        for eficAplicacao in listaEficAplicao:
                            
                            # Para tranformar mm/ha em m3/ha, multiplica-se por 10 
                            RetiradaIrrigacao = ((ETrcTotalMensal-precipitacaoEfetiva) * (areaIrrigadaCultivo * 10) ) / float(eficAplicacao)
                            
                            # converte de m3/mês para m3/s
                            RetiradaIrrigacao = (RetiradaIrrigacao/NUMERO_DIAS_MES)/NUMERO_SEGUNDOS_DIA
    
                            if RetiradaIrrigacao<0:
                                RetiradaIrrigacao = 0

                            listaRetiradaIrrigacao.append(RetiradaIrrigacao)
                             
                        # Inclusao na tabela de retirada de agua para irrigacao
                        cursorDestino = arcpy.InsertCursor(Constantes.TABELA_RETIRADA_IRRIGACAO_POR_CULTIVO_POR_MUNICIPIO, atributosTabRetiradaIrrigacao)
                        row = cursorDestino.newRow()
                        row.setValue(atributosTabRetiradaIrrigacao[0], codigoMunicipio)
                        row.setValue(atributosTabRetiradaIrrigacao[1], nomeMunicipio)
                        row.setValue(atributosTabRetiradaIrrigacao[2], areaMunicipio)
                        row.setValue(atributosTabRetiradaIrrigacao[3], ano)
                        row.setValue(atributosTabRetiradaIrrigacao[4], mes)
                        row.setValue(atributosTabRetiradaIrrigacao[5], classeCultivo)
                        row.setValue(atributosTabRetiradaIrrigacao[6], areaIrrigadaCultivo)
                        row.setValue(atributosTabRetiradaIrrigacao[7], precipitacaoBruta)
                        row.setValue(atributosTabRetiradaIrrigacao[8], precipitacaoEfetiva)
                        row.setValue(atributosTabRetiradaIrrigacao[9], ETrcTotalMensal)
                        
                        indice=9
                        for RetiradaIrrigacao in listaRetiradaIrrigacao:
                            indice+=1
                            row.setValue(atributosTabRetiradaIrrigacao[indice], RetiradaIrrigacao)
                        
                        cursorDestino.insertRow(row)
                        
        # Cria um indice para a tabela Constantes.TABELA_RETIRADA_IRRIGACAO_POR_CULTIVO_POR_MUNICIPIO
        atributos = [Constantes.NOME_ATRIBUTO_CODIGO_MUNICIPIO, Constantes.NOME_ATRIBUTO_ANO, Constantes.NOME_ATRIBUTO_MES]
        nomeIndice = "indice"
        arcpy.AddIndex_management(Constantes.TABELA_RETIRADA_IRRIGACAO_POR_CULTIVO_POR_MUNICIPIO, atributos, nomeIndice, "NON_UNIQUE", "ASCENDING")
        
        arcpy.AddMessage(time.ctime() + ' - Retirada de agua para irrigacao por cultivo, por municpio computado.')
...
def configurarTabelaCapacidadeTotalArmazenamento(nomeTabela):
    ...
    try:
        ...
        nomeAtributo = Constantes.NOME_ATRIBUTO_CAP_AGUA_DISP
        arcpy.AddField_management(nomeTabela, nomeAtributo, "DOUBLE", "", "", "", "", "", "REQUIRED")

        nomeAtributo = Constantes.NOME_ATRIBUTO_PROF_RAIZ_CULTIVO
        arcpy.AddField_management(nomeTabela, nomeAtributo, "DOUBLE", "", "", "", "", "", "REQUIRED")
...
def configurarTabelaFatorDisponibilidadeAguaCultivo(nomeTabela):
    ...
    try:
        ...
        nomeAtributo = Constantes.NOME_ATRIBUTO_FAT_DSP_AGUA_REF
        arcpy.AddField_management(nomeTabela, nomeAtributo, "DOUBLE", "", "", "", "", "", "REQUIRED")
...
def configurarTabelaRetiradaIrrigacaoPorCultivoPorMunicipio(nomeTabela):
    """
    """   
...
def configurarTabelaEvapotranspiracaoPotencialCultivoPorMunicipio(nomeTabela):
    ...
    try:
        ...
        nomeAtributo = Constantes.NOME_ATRIBUTO_COEF_CULTIVO
        arcpy.AddField_management(nomeTabela, nomeAtributo, "DOUBLE", "", "", "", "", "", "REQUIRED")
...
eficAplicacao = arcpy.GetParameterAsText(11)    
workspace = arcpy.GetParameterAsText(12)
